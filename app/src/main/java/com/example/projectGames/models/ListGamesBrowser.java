...
public class ListGamesBrowser implements Parcelable
{
    ...
    public final static Creator<ListGamesBrowser> CREATOR = new Creator<ListGamesBrowser>() {


        @SuppressWarnings({
            "unchecked"
        })
        public ListGamesBrowser createFromParcel(android.os.Parcel in) {
    ...
    protected ListGamesBrowser(android.os.Parcel in) {
