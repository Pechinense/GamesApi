...
public class OneGame {
    ...
    @Expose
    private MinimunSystemRequirements minimumSystemRequirements;
    ...
    public MinimunSystemRequirements getMinimumSystemRequirements() {
        return minimumSystemRequirements;
    }

    public void setMinimumSystemRequirements(MinimunSystemRequirements minimumSystemRequirements) {
